...
(function(){
    ...
    d_main_btn.style.cssText = "position: fixed; z-index: 9999999999; box-sizing: content-box; height: 43px; bottom: 0px; padding: 0px 20px; border-radius: 4px 4px 0px 0px; right:80px; background-color:#4caf50;";
    //加载对话框div
