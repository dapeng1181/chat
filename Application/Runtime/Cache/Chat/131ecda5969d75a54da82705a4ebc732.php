    ...
    <div class="row">
        ...
        <div class="col-xs-10 rightcon">
            <div class="rightpanel">
                ...
                <?php if(!empty($list)): ?><div class="panel">
        ...
        <div class="row">
            <div class="col-xs-8" style="border-right: 1px solid #dddddd;">
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="visitid" data-visitid="<?php echo ($vo["visitid"]); ?>">
                        <td id="<?php echo ($vo["visitid"]); ?>"><?php echo ($vo["username"]); ?></td>
                        <td><?php echo ($vo["neartime"]); ?></td>
...
<?php else: ?>
    <p class="no-chat-tip">暂无会话消息</p><?php endif; ?>
<script>
    var $b = $("body");
    $(function(){
        //访客信息完善 表单样式修改
