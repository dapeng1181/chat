...
<head>
    ...
    <script src="/Public/dist/lib/chart/chart.min.js"></script>
    <script src="/Public/dist/lib/common/formvalid.js"></script>
    <script src="/Public/dist/lib/common/formPlaceholder.js"></script>
    <!--[if lt IE 9]>
    ...
    <script>
        ...
        $("<link>").attr({ rel: "stylesheet",type: "text/css",href: "/Public/dist/css/zui-"+$themename+"-theme.css"}).appendTo("head");
    </script>
</head>
<body>
<!--[if lt IE 8]>
        ...
        <div class="col-xs-2 leftcon">
            <div class="leftpanel">
                <div class="list-group">
                    ...
                    <a href="<?php echo U('Manage/Company/index');?>" class="list-group-item <?php if((CONTROLLER_NAME) == "Company"): ?>active<?php endif; ?>"><i class="icon-building"></i> 企业账号管理</a>
...
<p class="lead">企业帐户信息</p>
<div class="panel">
    <div class="panel-body">
        <form class="form-horizontal">
            <div class="form-group">
                <label class="col-xs-1 control-label">企业名称</label>
                <div class="col-xs-4">
                    <input type="text" name="company" id="company" value="" class="form-control input-lg">
                </div>
            </div>
            <div class="form-group">
                <label class="col-xs-1 control-label">企业联系人</label>
                <div class="col-xs-4">
                    <input type="text" name="linkman" id="linkman" value="" class="form-control input-lg">
                </div>
            </div>
            <div class="form-group">
                <label class="col-xs-1 control-label">手机</label>
                <div class="col-xs-4">
                    <input type="text" name="telephone" id="telephone" value="" class="form-control input-lg">
                </div>
            </div>
            <div class="form-group">
